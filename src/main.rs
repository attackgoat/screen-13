...
fn main() -> Result<(), IoError> {
    ...
    let project_arg = args().nth(1).expect("No project specified; re-run this command with the name of a project file as the argument. Example: `cargo run foo_program.toml`");
