...
//! ### Animations
//!
//! Model animations (`.gltf` _or_ `.glb` _only_) may be imported using an animation `.toml` file:
//!
//! ```text
//! [animation]
//! src = 'anims/peggy.glb'
...
//! ### Models
//!
//! Three dimensional models (`.gltf` _or_ `.glb` _only_) are loaded using a model asset file:
//!
//! ```text
//! [model]
...
//! - `offset`: Optional.
//! - `scale`: Optional.
//! - `[[model.mesh]]`: Optional. May be repeated. Describes the subset of meshes to be imported, if
//!   specified.
    ...
    R: Read + Seek,
{
    ...
    pub fn material_with_id(&self, id: MaterialId) -> MaterialDesc {
