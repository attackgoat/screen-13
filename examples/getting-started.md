...
**_NOTE:_** The following examples present code which should be read together as one complete program.
...
render
    ...
    .record(
        &camera,
        once(Draw::model(teapot, glossy_cat, transform)),
    );
```
